      ...
      <div className="px-5 py-12 md:py-20">
        <div className="mx-auto grid max-w-5xl items-center gap-12 lg:grid-cols-[1fr_420px]">
          <section className="hidden lg:block">
            <div className="af-eyebrow">ZERO TRUST / SECURE ACCESS</div>
            <h1 className="mt-4 max-w-xl font-[Space_Grotesk] text-5xl font-bold tracking-tight">Your security command center starts here.</h1>
            <p className="mt-5 max-w-lg leading-7 text-slate-400">Sign in to manage your organization, monitor AI traffic, enforce policies and review security events.</p>
            <div className="mt-8 space-y-3 text-sm text-slate-300">
              {['Organization-scoped access control', 'Enterprise SSO and MFA', 'Audit-ready security telemetry'].map((item) => (
                <div className="af-card af-card-pad flex items-center gap-3" key={item}>
          ...
          <section className="af-card af-card-pad w-full">
            <div className="mb-7 text-center">
              ...
              <p className="mt-2 text-sm text-slate-400">Access your AI Firewall workspace.</p>
            </div>
            ...
            <form onSubmit={submit} className="space-y-5">
              <label className="block">
                ...
                <div className="relative mt-2">
                  ...
                  <input type="password" required value={password} onChange={(e) => setPassword(e.target.value)} placeholder="Your password" className="w-full rounded-xl border border-slate-700 bg-slate-950/70 py-3 pl-10 pr-3 text-sm text-white outline-none focus:border-cyan-400" />
                </div>
              </label>
